class WpApp extends JView
    ...
    constructor:->
        ...
        @dashboardTabs.on "PaneDidShow", (pane)=>
            if pane.name is "dashboard"
                ...
                @buttonGroup.buttonReceivedClick @buttonGroup.buttons["Install a new ZendFramework2"]
    ...
    pistachio:->
        ...
        <header>
          <figure></figure>
          <article>
            <h3>ZendFramework2 SkeletonApplication Installer</h3>
